...
function DeleteMaintenance({ itemDetails }) {
  const buttonStyle3 = {
  ...
  const sessionSuccess = () => {
    swal({
      title: 'Successful!',
      text: 'Maintenance Successfully Deleted!',
      icon: 'success'
    });
  };
...
function handleSubmit() {
  ...
  if (password === 'admin@gmail.com') {
    axios
      .delete(`http://localhost:3061/mongo/assetMaintenance/${code}`, {
        headers: {
